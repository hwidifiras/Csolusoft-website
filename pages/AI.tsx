      ...
      <section className="py-24 bg-gradient-to-b from-slate-50 to-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 tracking-tight">
            L'IA au service de <br/><span className="text-primary-500">votre stratégie.</span>
          </h1>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4">Articles & Ressources IA</h2>
            <p className="text-lg text-slate-600">Explorez les possibilités de l'intelligence artificielle pour votre entreprise</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Link to="/blog/intelligence-artificielle-entreprise-tunisienne" className="group bg-white rounded-2xl overflow-hidden border border-slate-200 hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                <span className="text-xs font-bold text-orange-500 uppercase tracking-wide">Intelligence Artificielle</span>
                <h3 className="text-xl font-bold text-slate-900 mt-2 mb-3 group-hover:text-primary-500 transition-colors">Comment l'IA Peut Transformer Votre Entreprise en 2026</h3>
                <p className="text-slate-600 text-sm">Découvrez des applications concrètes de l'IA pour votre PME.</p>
              </div>
            </Link>
            <Link to="/blog/erp-moderne-vs-excel-pourquoi-migrer" className="group bg-white rounded-2xl overflow-hidden border border-slate-200 hover:shadow-xl transition-all">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mt-2 mb-3 group-hover:text-primary-500 transition-colors">ERP Moderne avec IA Intégrée</h3>
                <p className="text-slate-600 text-sm">Combinez la puissance de l'ERP et de l'IA pour des décisions éclairées.</p>
              </div>
            </Link>
          </div>
        </div>
