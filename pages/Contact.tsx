  ...
  return (
    <div className="bg-slate-50 dark:bg-dark-900 min-h-screen transition-colors">
      <SEO
        ...
        description="Contactez CSoluSoft à Sfax pour un devis gratuit en facturation électronique, ERP, développement sur mesure et projets IA."
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 bg-white dark:bg-dark-800 p-6 rounded-2xl border-2 border-primary-200 dark:border-primary-500/20 shadow-lg shadow-primary-100/50 dark:shadow-primary-500/10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <a
                ...
                className="inline-flex w-full md:w-auto md:justify-self-end items-center justify-center rounded-xl bg-primary-500 dark:bg-primary-600 px-6 py-3 font-bold text-white transition-all hover:bg-primary-600 dark:hover:bg-primary-700"
              >
                Planifier maintenant
              </a>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-3 md:text-right">30 min • Gratuit • Sans engagement</p>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div className="mt-8 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm">
                  <iframe
                    ...
                    src="https://www.google.com/maps?q=34.760771300527196,10.77274966127345&z=16&output=embed"
                    width="100%"
                    height="200"
                    style={{ border: 0 }}
                    loading="lazy"
